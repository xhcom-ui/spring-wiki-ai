    ...
    <div class="auth-panel auth-panel-extended">
      <div class="hero-copy auth-hero">
        <div class="auth-hero-head">
          <div>
            <p class="eyebrow">Flowable Studio</p>
        ...
        <p class="hero-text">
          ...
          前端工作区已经按业务入口、审批动作和监控反馈做过统一编排，适合直接扩业务。
        </p>
        ...
        <div class="auth-feature-grid">
          ...
          <article class="auth-feature-card">
            ...
            <strong>运行实例与历史追踪</strong>
            <p>统一查看实例详情、执行历史、变量快照和轨迹信息。</p>
          </article>
        </div>
...
.auth-hero {
  gap: 24px;
  background:
    radial-gradient(circle at top left, rgba(183, 119, 39, 0.18), transparent 28%),
    radial-gradient(circle at right bottom, rgba(47, 125, 50, 0.12), transparent 30%),
