 ...
 */
@Slf4j
public class PgWalDataDispatcher implements PgWalEventListener {
    private final Map<Long, PgTable> tableNameMap = new HashMap<>();
    private final Map<String, List<PgDataListenerContainer>> listenerMap = new HashMap<>();
    ...
    public void addListener(String database, String table, List<PgDataListenerContainer> listeners) {
