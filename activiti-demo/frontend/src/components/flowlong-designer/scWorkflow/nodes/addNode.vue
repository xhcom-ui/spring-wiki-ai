<template>
	 <div class="add-node-btn-box">
        ...
        :hide-after="0"
        :show-after="0"
        popper-class="flowlong-add-node-popper">
				<template #reference>
					<el-button class="flowlong-add-node-trigger" type="primary" icon="el-icon-plus" circle></el-button>
				</template>
...
.flowlong-add-node-trigger:hover,
.flowlong-add-node-trigger:focus-visible {
  background: #3296fa;
}

.flowlong-add-node-trigger :deep(.el-icon) {
  font-size: 14px;
}

.flowlong-add-node-popper {
