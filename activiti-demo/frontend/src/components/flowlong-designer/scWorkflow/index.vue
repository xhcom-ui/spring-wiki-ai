...
.sc-workflow-design {
  width: 100%;
  --workflow-line: #d7dde7;
  --workflow-line-strong: #cfd7e3;
  --workflow-mask: #f5f5f7;
  --workflow-arrow: #b8c3d4;
}
...
.sc-workflow-design {
  ...
  .node-wrap-box::before {
    ...
    border-color: var(--workflow-line-strong) transparent transparent;
  }
  ...
  .branch-box {
    ...
    min-height: 180px;
    height: auto;
    border-bottom: 2px solid var(--workflow-line);
    border-top: 2px solid var(--workflow-line);
    position: relative;
    margin-top: 15px;
  }
  ...
  .top-right-cover-line {
    ...
    height: 3px;
    width: 50%;
    background-color: var(--workflow-mask);
    top: -2px;
  }
  ...
  .end-node-circle {
    ...
    margin: auto;
    border-radius: 50%;
    background: var(--workflow-line-strong);
  }
  .end-node-text {
    margin-top: 5px;
    text-align: center;
  ...
  .auto-judge .sort-left .el-icon,
  .auto-judge .sort-right .el-icon,
  .branch-box .el-icon-arrow-left,
  .branch-box .el-icon-arrow-right {
...
.add-node-popover-body li:hover {
  box-shadow: none;
}
