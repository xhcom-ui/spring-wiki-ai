...
const TaskRuntimeView = () => import('../views/TaskRuntimeView.vue')
const TaskPageCatalogView = () => import('../views/TaskPageCatalogView.vue')
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: '工作台首页', permission: 'dashboard:view' }
        },
        {
          path: 'designer',
          name: 'designer',
          component: ProcessStudioView,
          meta: { title: '流程设计', permission: 'process:design' }
        },
        {
          path: 'leave',
          name: 'leave',
          component: LeaveView,
          meta: { title: '请假发起', permission: 'leave:submit' }
        },
        {
          path: 'tasks',
          name: 'tasks',
          component: TaskCenterView,
          meta: { title: '待办任务', permission: 'task:approve' }
        },
        {
          path: 'task-runtime/:pageKey?',
          name: 'task-runtime',
          component: TaskRuntimeView,
          meta: { title: '业务办理页', permission: 'task:approve' }
        },
        {
          path: 'users',
          name: 'users',
        ...
        },
        {
          ...
          meta: { title: '菜单权限', permission: 'menu:manage' }
        },
        {
          path: 'orchestration',
          name: 'orchestration',
          component: OrchestrationView,
          meta: { title: '流程编排', permission: 'orchestration:manage' }
        },
        {
          path: 'versions',
          name: 'versions',
          component: VersionCompareView,
          meta: { title: '版本历史对比', permission: 'process:compare' }
        },
        {
          path: 'monitoring',
          name: 'monitoring',
          component: MonitoringView,
          meta: { title: '流程监控中心', permission: 'monitoring:view' }
        },
        {
          path: 'runtime-catalog',
          name: 'runtime-catalog',
          component: TaskPageCatalogView,
          meta: { title: '业务页目录', permission: 'runtime:catalog:manage' }
        }
      ]
    }
  ]
...
router.afterEach((to) => {
  const pageTitle = to.meta?.title ? `${to.meta.title} · Activiti 工作台` : 'Activiti 工作台'
